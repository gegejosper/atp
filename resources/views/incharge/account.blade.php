        ...
        <div class="x_panel">
            ...
            <div class="col-lg-3">
                ...
                <table class="table table-striped" style="margin-top:10px;">
                    ...
                    <tr>
                        <td>Contact #: <strong>{{$Account->contactnum}}</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="/incharge/viewpaymenthistory/{{$Account->id}}" class="btn btn-info"><i class="fa fa-print"></i> Print Payment History</a></td>
                    </tr>
                </table>
                @endforeach
            </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_recentbill" aria-labelledby="recentbill-tab">
                                <table class="table table-striped" id="table">
                                    ...
                                    <tr class="item{{$Account->id}}">
                                        ...
                                        <td class='td-actions'>
                                            <a href="/incharge/pay/{{$Account->id}}" class='btn btn-info btn-small'><i class='fa fa-money'></i></a>
                                            <a href="/incharge/bill/{{$Account->id}}" class='btn btn-info btn-small'><i class='fa fa-search'></i></a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_bill" aria-labelledby="bill-tab">
                                <table class="table table-striped" id="table">
                                    ...
                                    <tr class="item{{$AccountHistory->id}}">
                                        ...
                                        <td><a href="/incharge/bill/{{$AccountHistory->id}}">{{$AccountHistory->billnum}}</a></td>
                                        ...
                                        <td class='td-actions'>
                                            <a href="/incharge/bill/{{$AccountHistory->id}}" class='btn btn-info btn-small'><i class='fa fa-search'></i></a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
